...
class SOHDataset(Dataset):
    ...
    def __init__(self, data_dir, split,
        ...
        print(f"[{split}] 共 {len(self.samples)} 个样本，来自 {len(files)} 个文件")
    ...
    # def _load_mat(self, fpath, file_idx):          # add file_idx if ids collide
    #     mat = loadmat(fpath)
    ...
    def __getitem__(self, idx):
        ...
        # GAF_gen: [K, H, W] -> [K, 1, H, W], normalized to [-1, 1]
