...
"""Central configuration for the image-only LFP SOH estimator."""
import argparse
import torch
...
class SOHConfig:
    ...
    n_gen_train     = 30                # 3 windows x 10 images
    n_gen_val       = 10                # one selected window x 10 images
    ...
    lambda2         = 0.2               # L_real weight
    lambda1         = 2               # L_gen weight
