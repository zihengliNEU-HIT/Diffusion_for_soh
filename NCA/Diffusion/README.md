# NCA Conditional CAF Diffusion and SOH Input Preparation

This repository contains the NCA version of the conditional CAF/GAF diffusion workflow. It trains and evaluates a diffusion model, generates selected-window GAF samples, and converts those generated MAT files into SOH-estimation inputs.

This README is written for the current NCA codebase. The NCA-specific settings are:

```text
chemistry labels      : 025C / 05C / 1C
condition vector dim  : 22
...
```text
025Cbattery1_02_train_sliding.mat
025Cbattery2_02_val_sliding.mat
025Cbattery6_02_test_sliding.mat
05Cbattery16_02_test_sliding.mat
1Cbattery4_02_test_sliding.mat
```
...
Put NCA capacity/SOH source files here:
...
Important NCA fields:

```text
cond_vector_dim: 22
timesteps      : 300
chemistry      : 025C / 05C / 1C
```
