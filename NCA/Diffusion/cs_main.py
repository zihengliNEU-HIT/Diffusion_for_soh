...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir", type=str, default="./data", help="Directory containing MAT files."
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument(
        "--num_epochs", type=int, default=260, help="Number of training epochs."
    )
    parser.add_argument("--lr", type=float, default=0.001, help="Learning rate.")
    parser.add_argument(
        "--timesteps", type=int, default=300, help="Number of diffusion timesteps."
    )
    parser.add_argument(
        "--eval_interval", type=int, default=5, help="Validation interval in epochs."
    )
    parser.add_argument(
        "--save_interval", type=int, default=10, help="Checkpoint interval in epochs."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--step_size", type=int, default=10, help="StepLR decay interval."
    )
    parser.add_argument(
        "--step_gamma", type=float, default=0.8, help="StepLR decay factor."
    )
    parser.add_argument(
        "--noise_schedule",
        type=str,
    ...
    parser.add_argument(
        "--clip_grad", type=float, default=0.01, help="Gradient clipping threshold."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Sample index for optional inspection.",
    )
    parser.add_argument(
        "--cosine_s",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=22,
        help="Scalar condition-vector dimension.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--ddim_eta", type=float, default=0.0, help="DDIM stochasticity."
    )
