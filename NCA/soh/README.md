...
Image-only state-of-health (SOH) estimation for NCA battery capacity prediction. The model uses SOH-ready GAF MAT files produced by the Diffusion workflow.
...
- `SOH_model.py` - CNN encoder, transformer regressor, and model builder.
...
Keep the same `soh_input` layout as `NCA/Diffusion`:

```text
NCA/Diffusion/soh_input/train       -> NCA/soh/soh_input/train
NCA/Diffusion/soh_input/val         -> NCA/soh/soh_input/val
NCA/Diffusion/soh_input/test_low    -> NCA/soh/soh_input/test_low
NCA/Diffusion/soh_input/test_middle -> NCA/soh/soh_input/test_middle
NCA/Diffusion/soh_input/test_high   -> NCA/soh/soh_input/test_high
NCA/Diffusion/soh_input/test_random -> NCA/soh/soh_input/test_random
```
